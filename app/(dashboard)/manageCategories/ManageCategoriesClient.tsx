...
import AllCategories from "@/app/(dashboard)/manageCategories/components/AllCategories";
import AddCategory from "@/app/(dashboard)/manageCategories/components/AddCategory";
